...
class siemensSpider(Spider):
    ...
    def parse(self, response):
        ...
        nbrowser = webdriver.PhantomJS(executable_path="/home/cy/appHome/phantomjs-2.1.1-linux-x86_64/bin/phantomjs")
    ...
    def parse_page(self,url,browser):
        ...
        for line in lines:
            ...
            absfirmurl = urlparse.urljoin(url,firmurl)  #https://support.industry.siemens.com/cs/document/31045047/simotion-d-%E5%9B%BA%E4%BB%B6%EF%BC%88%E5%86%85%E6%A0%B8%EF%BC%89?lc=zh-CN
            ...
            if filetype in siemensSpider.suffix:
                ...
                if regVersions:
                    item["productVersion"] = regVersions.group().rstrip('_')
                else:
                    item["productVersion"] = ""
        ...
        #return
        #print "all suffix:",siemensSpider.allsuffix
