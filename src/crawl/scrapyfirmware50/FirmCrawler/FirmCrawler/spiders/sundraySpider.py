...
class sundraySpider(Spider):
    ...
    start_urls = ["http://www.sundray.com.cn/data/32_97.html"]
    # must be lower character
    typefilter = ["txt", "pdf", "apk"]
    allsuffix = Set()
    def parse(self, response):
        for i in xrange(1,3+1): #3+1
            url = "http://www.sundray.com.cn/data/32_97_page_%s.html" %i
            if i == 1:
                url = "http://www.sundray.com.cn/data/32_97.html"
